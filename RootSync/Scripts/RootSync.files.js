...
(function (context, undefined) {
    ...
    rootsync.files = rootsync.files || {};
    var files = rootsync.files;

    files.cbHeader_OnClick = function (element) {
        if (element.checked) {
            $('.clsFileCheckbox').attr('checked', 'checked');
            $('.clsFolderCheckbox').attr('checked', 'checked');
        } else {
            $('.clsFileCheckbox').removeAttr('checked');
            $('.clsFolderCheckbox').removeAttr('checked');
        }
    };

    var inputDialog;
    var showInputDialog = files.showInputDialog = function (dialogTitle, dialogText, okCallBack, cancelCallBack) {
